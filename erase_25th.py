...
# Erase anything from the 25th onwards
target_dt = datetime.datetime(2026, 3, 25)
...
if deleted > 0:
    print(f"Filtering complete. Detected {deleted} incomplete records from the 25th.")
    print("Saving cleaned parquet file...")
    pq.write_table(filtered_table, master_file + ".clean")
    os.replace(master_file + ".clean", master_file)
    print("Done! Database successfully reverted to the end of March 24th.")
else:
    print("No records found for the 25th or later.")
